...
import logo from '/src/assets/draft-room-logo.png';
...
const nav = () => {
  ...
  return (
    <div className='navbar fixed-nav font-main font-medium border-b-2 border-base-content'>
      <div className='navbar-start'>
        ...
        <Link to='/' className='btn btn-ghost text-2xl font-header'>
          <img src={logo} alt='Logo' className='inline-block mr-2 w-10 h-10' />{' '}
          Draft Room
        </Link>
      </div>
